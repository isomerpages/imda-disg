...
<img style="width: 100%" height="auto" width="100%" alt="Amazon Web Services (AWS)" src="/images/AWS_logo.png">
</div>
</div>
<div class="isomer-card-body">
<div class="isomer-card-title">Amazon Web Services (AWS)</div>
<div class="isomer-card-description">he ECI-AWS programme helps organisations build AI capabilities through
